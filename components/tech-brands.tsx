...
const TechBrands = () => {
  ...
  return (
    <section className="pt-5 md:pt-10 pb-10 bg-background overflow-hidden border-b border-border/50">
      <div className="container mx-auto px-6">
        ...
        >
          <p className="text-xs font-bold text-muted-foreground tracking-wider mb-3 uppercase">
            Công nghệ sử dụng
          </p>
        </motion.div>
